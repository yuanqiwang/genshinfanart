...
const FeaturedPostCard = ({ post }) => (
  <div className="relative h-160">
    <div className="absolute rounded-lg bg-center bg-no-repeat bg-cover shadow-md inline-block w-full h-160" style={{ backgroundImage: `url('${post.featuredImage.url}')` }} />
